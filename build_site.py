...
NAV_OVERRIDE = {
    ...
    "10_三法_法條速記表": "三法 法條速記表",
    "10_稅務_現行數字速查表": "稅法 數字速查表",
    "11_稅務_深掘_計算題解題範本": "稅法 計算題範本",
    "12_稅務_深掘_所得稅_AMT_CFC": "稅法 AMT加計項目・CFC",
    "13_稅務_深掘_遺產及贈與稅": "遺產及贈與稅★★★",
    "13b_稅務_深掘_不動產稅": "稅法 不動產（自用住宅比較・土增・地價）",
...
<nav id="sidebar">
  <div class="brand">會計師考試<small>重點整理 · 點左側切換</small>
    <a href="cards.html" style="display:block;margin-top:10px;padding:8px 12px;background:rgba(37,99,235,.25);border:1px solid rgba(37,99,235,.5);border-radius:9px;color:#fff;text-decoration:none;font-size:13.5px;font-weight:700;text-align:center">🃏 記憶字卡（三法·稅務·審計）</a>
  </div>
